...
export function ImpactSnapshot() {
  return (
    <section className="w-full bg-white px-4 sm:px-8 py-10 md:py-16 shadow-lg max-w-full mx-auto">
      {/* Fast facts grid */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-800 mb-12">
        {/* Year Started */}
        <div className="flex flex-col items-center md:items-start space-y-2">
          <h3 className="text-lg font-semibold text-blue-700">Year Started</h3>
