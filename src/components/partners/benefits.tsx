      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Prominent logo placement on race materials, website, and social
            media
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Direct contribution to supporting the next generation of healthcare
            professionals
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Connect with healthcare leaders, medical professionals, and
            community members
          </p>
        </div>
      </div>
