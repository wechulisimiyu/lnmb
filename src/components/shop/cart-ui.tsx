  ...
  return (
    <div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          onClick={toggle}
          className="bg-blue-600 text-white p-3 rounded-full shadow-lg flex items-center space-x-2"
        >
      ...
      <div
        ...
        } fixed top-0 right-0 h-full w-full sm:w-96 bg-white shadow-2xl transform transition-transform z-50`}
      >
            ...
            <div key={idx} className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <input
                    aria-label={`cart-item-quantity-${idx}`}
                    type="number"
                    min={1}
                    value={it.quantity}
                    onChange={(e) =>
