...
export function TeamMembers() {
  ...
  const teamByYear = {
    ...
    "2023": [
      ...
      {
        name: "Peter Ogutu",
        role: "Deputy Race Director",
        image: "Deputy Race Director.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "orange",
      ...
      {
        name: "Dr. Lynn Maina",
        role: "Deputy Organising Lead",
        image: "Deputy Organising Lead.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "green",
      ...
      {
        name: "Dr. Melvin Mwenda",
        role: "AMSUN Organising Secretary",
        image: "AMSUN Organising Secretary.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "teal",
      ...
      {
        name: "Dr. Muinde Nthusi",
        role: "AMSUN Chairperson",
        image: "AMSUN Chairperson.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "blue",
      ...
      {
        name: "Dr. Mwikali Wambua",
        role: "Publicity Lead",
        image: "Publicity Lead.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "purple",
      ...
      {
        name: "Dr. Faizal Baraza",
        role: "Logistics Lead",
        image: "Logistics Lead.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "purple",
      },
      {
        ...
        image: "Logistics Coordinator.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "blue",
      },
      {
        ...
        image: "External Affairs Team Leader.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "pink",
      ...
      {
        name: "Dr. Brian Mwau",
        role: "Sales & Finance Coordinator",
        image: "Sales & Finance Coordinator.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "orange",
      ...
      {
        name: "Dr. Sandra Lukorito",
        role: "Venue Manager",
        image: "Venue Manager.webp",
        email: "#",
        linkedin: "#",
        twitter: "#",
        color: "blue",
                    ...
                    <div className="bg-background rounded-xl overflow-hidden flex flex-col h-full">
                      ...
                      <div className="flex flex-col justify-between flex-grow p-4 sm:p-5 text-center">
                        <div>
                          ...
                          <p
                            className={`text-sm sm:text-base font-semibold ${colorClasses.text}`}
                          >
                            {member.role}
                          </p>
                        </div>
